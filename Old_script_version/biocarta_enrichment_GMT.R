...
perform_biocarta_samplewise_fgsea <- function(input_file, gmt_file, output_file) {
...
input_file <- args[1]
gmt_file <- args[2]
output_file <- ifelse(length(args) >= 3, args[3], "biocarta_fgsea_GMT_results.csv")

cat("Starting sample-wise BioCarta fgsea analysis...\n")
perform_biocarta_samplewise_fgsea(input_file, gmt_file, output_file)
