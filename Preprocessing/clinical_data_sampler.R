...
# ---- USER INPUTS ----
cancer_types <- c("CCRCC", "HNSCC", "PDA") # "BRCA", "LGG", "GBM", "KIRC"
...
data_files <- list(
  BRCA = "/Users/jackie-mac/Desktop/VSCode/data/clinical/GDC_clinical/BRCA_clinical.tsv",
  LGG  = "/Users/jackie-mac/Desktop/VSCode/data/clinical/GDC_clinical/LGG_clinical.tsv",
  GBM  = "/Users/jackie-mac/Desktop/VSCode/data/clinical/GDC_clinical/GBM_clinical.tsv",
  KIRC = "/Users/jackie-mac/Desktop/VSCode/data/clinical/GDC_clinical/KIRC_clinical.tsv",
  NSCLC = "/Users/jackie-mac/Desktop/VSCode/data/clinical/NSCLCR01Radiogenomic_DATA_LABELS_2018-05-22_1500-shifted.csv",
  CCRCC = "/Users/jackie-mac/Desktop/VSCode/data/clinical/GDC_clinical/CPTAC_clinical.tsv",
  HNSCC = "/Users/jackie-mac/Desktop/VSCode/data/clinical/GDC_clinical/CPTAC_clinical.tsv",
  PDA = "/Users/jackie-mac/Desktop/VSCode/data/clinical/GDC_clinical/CPTAC_clinical.tsv"
)
output_files <- list(
