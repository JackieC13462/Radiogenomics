#!/bin/bash
#SBATCH --output=/cluster/home/t138199uhn/slurm/slurm_logs/clinical_outcomes/pancancer_pipeline_%j.out
#SBATCH --error=/cluster/home/t138199uhn/slurm/slurm_logs/clinical_outcomes/pancancer_pipeline_%j.err
